...
transformed parameters {
  ...
  vector[n_serve_speed] sum_base_predictors_serve_speed = alpha_serve_speed_raw + alpha_serve_speed_int*progress_1minus2_abs[is_serve_speed_indices] + beta_serve_speed_player[Point_Server_id_serve_speed] + (beta_serve_number_speed_plus_1 - 1) * (ServeNumber[is_serve_speed_indices]-1.5)  + beta_serve_speed_match[serve_speed_match_id,1].*(2 - to_vector(PointServer[is_serve_speed_indices]))  + beta_serve_speed_match[serve_speed_match_id,2].*(to_vector(PointServer[is_serve_speed_indices]) - 1);
  vector[N] beta_surprise_player1 = beta_surprise_raw + beta_surprise_int*progress_1minus2_abs + beta_surprise_player_raw[id1]*sigma_beta_surprise_player;
  vector[N] beta_surprise_player2 = beta_surprise_raw + beta_surprise_int*progress_1minus2_abs + beta_surprise_player_raw[id2]*sigma_beta_surprise_player;
  vector[n_serve_speed] beta_serve_speed_surprise_server = beta_serve_speed_surprise_raw + beta_serve_speed_surprise_int*progress_1minus2_abs[is_serve_speed_indices] + beta_serve_speed_surprise_player_raw[Point_Server_id_serve_speed]*sigma_beta_serve_speed_surprise_player;
...
model {
  ...
  target += normal_lpdf(beta_surprise_int|0,0.1);
  ...
  target += normal_lpdf(beta_serve_speed_surprise_int|0,0.1);
...
generated quantities{
  ...
  real beta_serve_speed_surprise = beta_serve_speed_surprise_raw + mean(beta_serve_speed_surprise_player_raw*sigma_beta_serve_speed_surprise_player);
