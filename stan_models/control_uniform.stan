...
data {
  ...
  vector[n_score] p1_control;
  vector[n_score] p2_control;
  vector[n_score] p_server_control;
  vector[n_score] p_non_server_control;
...
transformed parameters {
  ...
  sum_base_predictors = alpha + beta_player[Point_Server_id] - beta_player[Point_non_Server_id] + beta_match[match_id].*player1_served + (beta_player_int_dev[Point_Server_id].* p_server_control) - (beta_player_int_dev[Point_non_Server_id] .* p_non_server_control);
  ...
  beta_surprise_player1 = beta_surprise_raw + beta_surprise_player_dev[id1] + (beta_surprise_int_raw + beta_surprise_int_player_dev[id1]).*p1_control;
  beta_surprise_player2 = beta_surprise_raw + beta_surprise_player_dev[id2] + (beta_surprise_int_raw + beta_surprise_int_player_dev[id2]).*p2_control;
  ...
  beta_serve_speed_surprise_server = beta_serve_speed_surprise_raw + beta_serve_speed_surprise_player_dev[Point_Server_id_serve_speed] + (beta_serve_speed_surprise_int_raw+beta_serve_speed_surprise_int_player_dev[Point_Server_id_serve_speed]).*p_server_control[is_serve_speed_indices];
