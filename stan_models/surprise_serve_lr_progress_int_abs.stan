...
transformed parameters {
  ...
  beta_serve_speed_surprise_server = beta_serve_speed_surprise_raw + beta_serve_speed_surprise_player_dev[Point_Server_id_serve_speed] + (beta_serve_speed_surprise_int_raw+beta_serve_speed_surprise_int_player_dev[Point_Server_id_serve_speed]).*progress_1minus2_abs[is_serve_speed_indices];
